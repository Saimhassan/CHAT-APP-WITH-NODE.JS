    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case TYPE_IMAGE_RECEIVED:
                ...
                return new ReceivedImageFolder(view);
        ...
        try {
            ...
            }else
            {
             if (message.has("message")){
                 ...
                 ReceivedImageFolder imageFolder = (ReceivedImageFolder) holder;
                 imageFolder.nameTxt.setText(message.getString("name"));

                 Bitmap bitmap = getBitmapFromString(message.getString("image"));
                 imageFolder.imageView.setImageBitmap(bitmap);
             }
            }
        } catch (JSONException e) {
            e.printStackTrace();
